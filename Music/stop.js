...
module.exports = {
  name: "stop",
  description: "\`(leave)Stops the musi\`",
  aliases: ["leave", "end"],
  cooldown: 5,
...
async execute(message,args,client) {
  ...
  message.react("<a:stop:813505072704913419>").catch(console.error);
  ...
  .setColor("RANDOM")
  .setAuthor(`${message.author.username} stopped the music!`, "https://cdn.discordapp.com/emojis/801528793407291442.gif?v=1"))
  .catch(console.error);
  }
};
