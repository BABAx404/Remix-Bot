...
execute(message) {
    ...
    message.react("<a:Erore:813505315534405632>").catch(console.error);
    //get the queue
    ...
    queue.textChannel.send(
      new MessageEmbed().setColor("#FC00FF").setAuthor(`${message.author.username} skipped the song.`, "https://cdn.discordapp.com/emojis/798080143217655809.gif?v=1")
    ).catch(console.error);
  }
};
